...
class ThreeLayerConvNet(object):
  ...
  def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
    ...
    self.params['W1'] = np.random.normal(0,weight_scale,(num_filters,channels,filter_size,filter_size))
    self.params['b1'] = np.zeros(num_filters)
    self.params['W2'] = np.random.normal(0,weight_scale,(num_filters*height*width/4,hidden_dim))#
  ...
  def loss(self, X, y=None):
    ...
    _, dw1, db1 = conv_backward_naive(dout,cache_conv)
